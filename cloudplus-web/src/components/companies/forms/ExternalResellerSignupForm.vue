<template>
  <external-signup-form :accountType="accountTypes.Reseller" :parentId="$props.parentId"></external-signup-form>
</template>
...
export default {
  ...
  created() {
    this.setAccountType(this.accountTypes.Reseller, this.roles.resellerAdmin.id);
  },
  computed: {
    ...mapGetters({
