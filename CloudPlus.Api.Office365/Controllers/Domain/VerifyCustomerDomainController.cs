...
{
    public class VerifyCustomerDomainController : ApiController
    {
        ...
        public VerifyCustomerDomainController(
        ...
        {
            this.Log().Info("=> VerifyCustomerDomainController");

            var script = _powershellScriptLoader.LoadScript(PowershellScripts.VerifyCustomerDomain);
