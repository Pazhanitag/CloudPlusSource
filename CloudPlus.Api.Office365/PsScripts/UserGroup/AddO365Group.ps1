...
#####################################################################################################################################################################
{
	...
	New-DistributionGroup -Name $DistributionGroupName -ManagedBy $ManagerSMTPAddress -MemberJoinRestriction $MemberJoinPolicy -ModerationEnabled $false -PrimarySmtpAddress $GroupSMTPAddress -Type "Security"
